            ...
            <form id="addForm" ng-controller="addFormCtrl" action="#">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="libelle_categorie" id="libelle_categorie" ng-model="categorie.libelle_categorie" onkeyup="this.value = this.value.charAt(0).toUpperCase() + this.value.substr(1);" placeholder="Antibiotique..." required/>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="table" class="table table-bordered table-hover table-checkable dataTable no-footer dtr-inline"
                                ...
                                <thead>
                                    <tr role="row">
                                        <th data-field="libelle_categorie" data-searchable="true">Nom de la cat&eacute;gorie</th>
                       ...
                       <div class="d-flex align-items-center p-5">
                           ...
                           <div class="d-flex flex-column">
                               <div class="text-dark-75 text-center"> 
                                   ...
                                   Etes vous certains de vouloir supprimer la cat&eacute;gorie ? <br/> <b>@{{categorie.libelle_categorie}}</b>
                               </div>
                           </div>
                       </div>
                   </div>
