...
class UserRegistred extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->success()
                    ->subject('Cration de votre compte Smart-Ordo.')
                    ->line("Votre compte Smart-Ordo a bien été crée mais il doit être confirmé. Merci de cliquer sur le bouton suivant.")
